...
if __name__ == "__main__":
    ...
    parser.add_argument("--boost-gc", action="store_true",
    ...
    parser.add_argument("--file-types", type=str, nargs='?', default="genome",
    ...
    parser.add_argument("--contig-n50-threshold", type=int, nargs='?', default=50000,
